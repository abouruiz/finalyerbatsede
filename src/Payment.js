...
export default class Payment extends Component {
    ...
    InsertRecord = () => {
        ...
        var Data = {
            ...
            taux: this.props.navigation.state.params.taux
        }
        ...
        fetch("https://yerbatsede.ml/insert2.php", {
            ...
            .then((responseJson) => {
                ...
                if (responseJson[0].Verificateur == 1) {
                    ...
                    setTimeout(() => {this.setState({ showWarning: true })}, 1000 )
                }
                else {
                    this.setState({ message: responseJson[0].Message })
                    this.setState({ showWarning2: false })
                    ...
                    <View style={styles.centered_view}>
                        <View style={styles.warning_modal}>
                            <View style={[styles.warning_body2, {}]}>
                                ...
                                <Text style={[styles.title, { fontSize: 15, paddingBottom: 20, paddingLeft: 20, width: '90%' }]}>{this.state.message}</Text>
                                <TouchableOpacity
                            ...
                            <View style={styles.infobox}>
                                ...
                                <View style={[{
                                    ...
                                    <Text style={[styles.text2, { marginBottom: 10, marginTop: 6, color: '#ffffff' }]}>
                                        {this.props.navigation.state.params.montant_transfert * this.props.navigation.state.params.taux} USDT
                                    </Text>
                                    <Text style={[styles.text2, { marginBottom: 10, marginTop: 6, color: '#ffffff' }]}>
