    ...
    priseinfo = () => {
        ...
        fetch("https://yerbatsede.ml/get_transaction.php", {
            ...
            .then((responseJson) => {
                ...
                //alert(responseJson[0].Transaction)
    ...
    renderFlatlist = () => {
        ...
        else
        {
            return (<View style={[{ height: '100%', justifyContent: 'center', alignItems: 'center' }]}>
                ...
                <Sendo onPress={this.priseinfo()}>

                    <Text style={[{justifyContent: 'center', fontSize: 15, color: '#ffffff'}]}> Actualiser </Text>
